...
@AllArgsConstructor
@NoArgsConstructor
@DynamoDBTable(tableName = "childrenMsgs")
public class ChildIsoMessage {
	...
	@DynamoDBAttribute(attributeName = "IdParentISOMsg")
	private String IdParentISOMsg;
	
	@DynamoDBAttribute(attributeName = "dateRegisterMessage")
	private String dateRegisterMessage;

	@DynamoDBAttribute(attributeName = "isoChildMessage")
	private String isoChildMessage;
